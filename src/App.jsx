...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    ...
    if (charAllowed) {
      str += "!@#$%^&*-_+=[]{}";
      pass += "!@#$%^&*-_+=[]{}".charAt(Math.floor(Math.random() * 16)); 
    }
  
    for (let i = pass.length + 1; i <= length; i++) {
  ...
  return (
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-5 py-6 my-10  bg-gray-200 text-black-500">
